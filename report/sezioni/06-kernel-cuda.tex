...
Questo rimane vero anche quando $\nloc < 32$. In questo caso alcune lane
possono non avere alcun indice $j$ da elaborare, ma non terminano
l'esecuzione: i loro accumulatori, inizializzati a zero, rimangono nulli
e partecipano comunque alla riduzione con contributo nullo, senza
alterare il risultato finale.
...
senza cambiare la mappatura del kernel. Durante il preprocessing, il blocco locale del multivettore viene riscritto
in layout \emph{column-major}, in modo che
