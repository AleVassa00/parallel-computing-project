...
La previsione ha una conseguenza direttamente misurabile, ed \`e quella che la
campagna C7 (\cref{sec:c7}) mette alla prova: il rapporto fra i tempi nelle
due precisioni deve \textbf{crescere con $k$}. Se fosse piatto e vicino a $2$,
sarebbe questo modello a essere sbagliato.
\end{tcolorbox}
