...
\input{sezioni/02-problema}
\input{sezioni/03-nucleo}
\input{sezioni/04-mpi}
\input{sezioni/05-kernel-cpu}
\input{sezioni/06-kernel-cuda}



\input{sezioni/08-metodologia}
\input{sezioni/10-risultati}
%\input{sezioni/11-conclusioni}

\appendix
\input{sezioni/A-oracolo-seriale}
\input{sezioni/B-ripartizione-lavoro}

\end{document}


% VALUTARE SE E COME INSERIRLE NEL DISCORSO

%\input{sezioni/07-roofline}
%\input{sezioni/09-validazione}
