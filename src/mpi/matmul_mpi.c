                ...
                matmul_time_t *t)
{
    ...
    /* 1. La fetta di X del processo (0, my_col) serve identica a tutti i
     *    processi della colonna my_col: root = rank 0 di col, che per
     *    costruzione e' il processo di riga 0. */
    t0 = MPI_Wtime();
